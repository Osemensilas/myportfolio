        ...
        <div className="h-full w-full flex relative z-10">
          <div className="h-full w-1/2 fixed top-0 left-0 flex items-center justify-center">
           <div className="h-max w-3/4">
            <h1 className="text-3xl font-bold text-accent mb-10">Osemen Silas</h1>
            <h2 className="text-4xl font-bold text-primary mb-10">Web Developer</h2>
            <nav className="h-max w-full">
              <ul className="h-max w-max mb-10">
                <li className="h-max w-max flex items-center">
                  <span className="mr-2 h-[2px] w-[75px] bg-accent rounded"></span>
                  <Link href={"#about"} className="text-accent text-base">About</Link>
                </li>
                <li className="h-max w-max flex items-center">
                  <span className="mr-2 h-[2px] w-[75px] bg-accent rounded"></span>
                  <Link href={"#experience"} className="text-accent base">Experience</Link>
                </li>
                <li className="h-max w-max flex items-center">
                  <span className="mr-2 h-[2px] w-[75px] bg-accent rounded"></span>
                  <Link href={"#project"} className="text-accent base">Project</Link>
                </li>
              </ul>
            </nav>
            <div className="w-max h-max flex justify-center items-center mb-20">
            ...
            <div className="flex items-center justify-center w-max h-full mb-20">
              <a href="https://www.instagram.com/silasosemen/" target="_blank" className="mr-10">
                  <i className="fa fa-instagram text-primary" style={{fontSize: "30px"}}></i>
              </a>
              <a href="https://web.facebook.com/osemen.silas" target="_blank" className="mr-10">
                  <i className="fa fa-facebook-square text-primary" style={{fontSize: "30px"}}></i>
              </a>
              <a href="https://x.com/OsemenSilas1" target="_blank" className="mr-10">
                  <i className="fa fa-twitter-square text-primary" style={{fontSize: "30px"}}></i>
              </a>
              <a href="https://www.linkedin.com/in/osemensilas/" target="_blank" className="mr-10">
                  <i className="fa fa-linkedin-square text-primary" style={{fontSize: "30px"}}></i>
              </a>
              <a href="https://wa.me/8168318983" target="_blank" className="mr-10">
          ...
          <div className="h-full w-full flex overflow-y-scroll">
            ...
            <div className="h-full w-1/2">
              <div id="about" className="w-full h-max">
                ...
                <div className="pr-10">
                  <p className="text-accent text-base text-justify mb-5">
                ...
                <div className="w-full h-max">
                  ...
                  <div className="h-max w-full">
                    <a href="#" target="__blank" className="mb-10 w-[95%] p-[10px] h-max flex items-start hover:shadow-xl cursor-pointer transition-all duration-300 ease-in-out">
                      ...
                      <div className="w-[70%] h-max">
                        <h2 className="font-bold text-base text-accent mb-5">Iruap Screen Recorder (Screen Recorder Web App)</h2>
                    ...
                    <a href="#" target="__blank" className="mb-10 w-[95%] p-[10px] h-max flex items-start hover:shadow-xl cursor-pointer transition-all duration-300 ease-in-out">
                      ...
                      <div className="w-[70%] h-max">
                        <h2 className="font-bold text-base text-accent mb-5">Iruap VTU Website (Mobile Top Up Web App)</h2>
                    ...
                    <a href="#" target="__blank" className="mb-10 w-[95%] p-[10px] h-max flex items-start hover:shadow-xl cursor-pointer transition-all duration-300 ease-in-out">
                      ...
                      <div className="w-[70%] h-max">
                        <h2 className="font-bold text-base text-accent mb-5">Freelance Market Place (Afrilancer)</h2>
                        <p className="text-grey text-base mb-5">A real-time utility platform that allows users to purchase airtime, data, TV subscriptions, and electricity tokens. Includes wallet funding and admin management.</p>
                        <ul className="w-full h-max flex flex-wrap">
                          <li className="text-primary mb-1 mr-1 text-sm py-1 px-4 rounded-full bg-grey">React Js</li>
                          <li className="text-primary mb-1 mr-1 text-sm py-1 px-4 rounded-full bg-grey">CSS</li>
