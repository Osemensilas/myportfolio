          ...
          <div className="h-max sm:h-full w-full flex overflow-hidden sm:overflow-y-scroll">
            ...
            <div className="h-full w-full sm:w-1/2 px-4">
              ...
              <div id="experience" className="w-full h-max">
                ...
                <a href="https://iruap-studio.vercel.app/" target="__blank" className="relative mb-10 w-[100%] sm:w-[95%] p-[10px] h-max flex flex-col-3 items-start hover:shadow-xl cursor-pointer transition-all duration-300 ease-in-out">
